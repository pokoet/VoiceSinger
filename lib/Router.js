        ...
        data:function(){
         ...
         onAfterAction: function () {
		    Tracker.afterFlush(function () {
				...
				//alert(singer);
				var mylike = like.findOne({singerId:singer,userId:user,status:'like'});

				//alert(mylike);
				var myunlike = like.findOne({singerId:singer,userId:user,status:'unlike'});
				//alert(myunlike);
				if(typeof mylike != 'undefined'){
					$("#like").addClass("like");
					$("#unlike").removeClass("like");
					$("#like").removeClass("currentlike");
				}else if(typeof myunlike != 'undefined'){
